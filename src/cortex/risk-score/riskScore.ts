...
export interface RawMetrics {
    ...
    fanIn:               number;  // number of files importing this file
}
...
export interface RiskScoreResult {
    ...
    language:     string;
    globalScore:  number;
    hotspotScore: number;  // F2 — composite brut complexity * churn
    raw:          RawMetrics;
    details: {
        ...
        depthScore:               number;
        paramScore:               number;
        fanInScore:               number;  // F1 — scored fanIn
        fanIn:                    number;
        fanOut:                   number;
    };
}
...
//
// Pondération :
//   Complexité (cyclomatique blended)  28%
//   Complexité cognitive               19%
//   Taille des fonctions (blended)     14%
//   Profondeur d'imbrication           14%
//   Churn                              12%
//   Paramètres                          8%
//   Fan-in                              5%  ← F1
//
...
export function scoreFromRaw(
    ...
    // F2 — hotspot score : composite brut complexity × churn (valeur non normalisée)
    ...
    return {
        ...
        details: {
            ...
            paramScore,
            fanInScore,
            fanIn:  0,  // sera rempli par scanner après le calcul des edges
            fanOut: 0,
        },
    };
}
